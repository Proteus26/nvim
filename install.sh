...
echo
echo
echo "Step 1: Cloning Nvim on ~/.config/nvim"
echo "------------------------------------------------------------------"
...
echo
echo
echo "Nvim has been correctly installed"
echo "========================================"
echo "The first time you open Nvim, it will install the next things concurrently:"
echo ""
